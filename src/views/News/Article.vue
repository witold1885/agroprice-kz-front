...
export default {
	...
	methods: {
		...mapActions('info', ['getArticle', 'increaseArticleViews']),
		handleResize () {
		...
		fixImagesSize () {
			...
			for (let line of lines) {
				...
				if (images.length == 1) {
					...
					let width, height
					if (this.localBreakpoint == 'xl') {
						width = 860
						height = 860 / rate
					}
					else if (this.localBreakpoint == 'lg') {
						width = 860 * window.innerWidth / 1440
						height = width / rate
					}
					else if (this.localBreakpoint == 'md') {
						width = 688
						height = 688 / rate
					}
					else if (this.localBreakpoint == 'sm') {
						width = 688 * window.innerWidth / 768
						height = width / rate
					}
					else if (this.localBreakpoint == 'xs') {
